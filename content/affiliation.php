        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(affiliations, function(index, affiliation) {
                    affiliationSelect.append('<option value="'+affiliation.id+'">'+affiliation.name+'</option>');
                });
            }
        });
    }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(options, function(index, option) {
                    universitySelect.append('<option value="'+option.id+'">'+option.name+'</option>');
                });
            }
        });
    }
    ...
    $("#addDocumentForm").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#fetch-documents").click(); // Refresh table
            }
        });
    });
});
